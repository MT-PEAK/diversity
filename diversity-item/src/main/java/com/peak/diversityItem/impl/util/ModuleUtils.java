...
public class ModuleUtils {
    ...
    public static boolean hasStackInHands(Item checkedItem, LivingEntity entity) {
        return entity.getMainHandStack().isOf(checkedItem) || entity.getOffHandStack().isOf(checkedItem);
    }
